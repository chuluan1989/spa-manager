...
export const ADMIN_ONLY_PERMISSIONS = [
  ...
  PERMISSION_KEYS.EDIT_EMPLOYEE,
  PERMISSION_KEYS.LOCK_EMPLOYEE,
  PERMISSION_KEYS.MANAGE_EMPLOYEES,
  PERMISSION_KEYS.TRANSFER_EMPLOYEE,
...
export const DEFAULT_PERMISSIONS = {
  ...
  [PERMISSION_KEYS.ADD_EMPLOYEE]: [ROLES.ADMIN],
  [PERMISSION_KEYS.EDIT_EMPLOYEE]: [ROLES.ADMIN],
  [PERMISSION_KEYS.TRANSFER_EMPLOYEE]: [ROLES.ADMIN],
  [PERMISSION_KEYS.LOCK_EMPLOYEE]: [ROLES.ADMIN],
  ...
  [PERMISSION_KEYS.MANAGE_EMPLOYEES]: [ROLES.ADMIN],
