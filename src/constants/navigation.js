export const NAV_ITEMS = [
  ...
  { id: 'reports', label: 'Báo cáo', icon: 'report', description: 'Doanh thu • Lương • Yêu cầu NV' },
  ...
  { id: 'employee-kpi', label: 'KPI', icon: 'kpi', description: 'KPI dịch vụ theo hóa đơn' },
  { id: 'admin-kpi', label: 'KPI', icon: 'kpi', description: 'Dashboard KPI & cấu hình chỉ tiêu' },
