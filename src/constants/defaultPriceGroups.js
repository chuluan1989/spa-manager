...
export const DEFAULT_PRICE_GROUPS = {
  [PRICE_GROUP_IDS.STANDARD]: [
    ...
    { id: 'body-90', name: 'Body 90', price: 249000, commissionPercent: C.TEN },
    { id: 'chuyen-sau', name: 'Chuyên sâu', price: 349000, commissionPercent: C.TWENTY },
  ...
  [PRICE_GROUP_IDS.SONG_KHOE_SPA]: [
    ...
    { id: 'body-90', name: 'Massage Body 90 phút – đá nóng lưng + chân', price: 250000, commissionPercent: C.TEN },
    ...
    { id: 'chuyen-sau', name: 'Chuyên sâu 90 phút', price: 350000, commissionPercent: C.TWENTY },
