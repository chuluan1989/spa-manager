...
const CS_30 = ['bac-lieu', 'tra-vinh', 'vinh-long']
const TIERED = ['soc-trang', 'tram-spa', 'song-khoe-spa']

const ZERO_IDS = ['body-60', 'body-75', 'foot', 'co-vai-gay']
const ZERO_NAMES = ['body 60', 'body 75', 'foot', 'cvg', 'co vai gay', 'cổ vai gáy']
const TEN_IDS = ['combo-1', 'combo-2', 'combo-3', 'body-90']
const TEN_NAMES = ['combo 1', 'combo 2', 'combo 3', 'body 90']
const TWENTY_IDS = ['chuyen-sau']
const TWENTY_NAMES = ['chuyen sau', 'chuyên sâu']
  ...
  if (TIERED.includes(branchId)) {
    return {
      ...
      groups: [
        ...
        { rate: 20, serviceIds: [...TWENTY_IDS], serviceNames: [...TWENTY_NAMES] },
      ],
    }
  }
...
const EXPECTED = {
  'tram-spa': { 'body-60': 0, 'body-75': 0, 'body-90': 10, 'co-vai-gay': 0, foot: 0, 'combo-1': 10, 'combo-2': 10, 'combo-3': 10, 'chuyen-sau': 20, 'goi-sach': 20, 'dap-thuoc': 20 },
  'soc-trang': { 'body-60': 0, 'body-75': 0, 'body-90': 10, 'co-vai-gay': 0, foot: 0, 'combo-1': 10, 'combo-2': 10, 'combo-3': 10, 'chuyen-sau': 20, 'goi-sach': 20, 'dap-thuoc': 20 },
  'song-khoe-spa': { 'body-60': 0, 'body-75': 0, 'body-90': 10, 'co-vai-gay': 0, foot: 0, 'combo-1': 10, 'combo-2': 10, 'combo-3': 10, 'chuyen-sau': 20, 'goi-sach': 20, 'dap-thuoc': 20 },
  'tra-vinh': { 'body-60': 20, 'body-75': 20, 'body-90': 20, 'co-vai-gay': 20, foot: 20, 'combo-1': 20, 'combo-2': 20, 'combo-3': 20, 'chuyen-sau': 30, 'goi-sach': 20, 'dap-thuoc': 20 },
  'vinh-long': { 'body-60': 20, 'body-75': 20, 'body-90': 20, 'co-vai-gay': 20, foot: 20, 'combo-1': 20, 'combo-2': 20, 'combo-3': 20, 'chuyen-sau': 30, 'goi-sach': 20, 'dap-thuoc': 20 },
...
const variants = [
  ...
  ['tra-vinh', { id: 'chuyen-sau', name: 'Chuyên sâu' }, 30],
]
